    ...
    private void seedNotices() {
        if (noticeRepository.count() == 0) {
            noticeRepository.save(Notice.builder()
                    ...
                    .content("یاری جو صرفاً جهت اطلاع‌رسانی است. مسئولیت هرگونه پرداخت، واریز وجه و انتقال وجوه بر عهده خود کاربر و مرکز خیریه مربوطه می‌باشد و این وب‌سایت هیچ‌گونه مسئولیتی در قبال تراکنش‌های مالی ندارد.")
